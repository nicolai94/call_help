...
from breaks.constants import REPLACEMENT_MEMBER_OFFLINE, REPLACEMENT_MEMBER_BREAK, REPLACEMENT_MEMBER_ONLINE
...
class BreakMeUpdateSerializer(InfoModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {
            'break-start': {'validators': [Time15MinutesValidator()]},
            'break-end': {'validators': [Time15MinutesValidator()]}
        }
    def validate(self, attrs):
        try:
